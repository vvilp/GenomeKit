...
label_input_file = "../alf-prot/data/MSA_all_aa.phy"
blast_output_file = "../alf-prot/Blast/blastp-fast-output"
trec_output_file = "../alf-prot/Blast/blastp-fast-output_trect"
